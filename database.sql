...
CREATE TABLE `profiles` (
  ...
  `time_of_birth` varchar(100) DEFAULT '',
  `place_of_birth` varchar(150) DEFAULT '',
  `height` varchar(50) DEFAULT '',
  `education` varchar(100) DEFAULT '',
  `occupation` varchar(100) DEFAULT '',
  `income` varchar(100) DEFAULT '',
  `address` text DEFAULT '',
  `father_name` varchar(150) DEFAULT '',
  `mother_name` varchar(150) DEFAULT '',
  `mobile` varchar(50) DEFAULT '',
  `manglik` varchar(50) DEFAULT '',
  `siblings` varchar(150) DEFAULT '',
  `gotra` varchar(100) DEFAULT '',
  `religion` varchar(50) DEFAULT 'Hindu',
  `caste` varchar(50) NOT NULL,
  `manglik_required` varchar(50) DEFAULT '',
  `family_gotra` varchar(100) DEFAULT '',
  `mother_gotra` varchar(100) DEFAULT '',
  `district` varchar(100) DEFAULT '',
  `tehsil_post` varchar(150) DEFAULT '',
  `note` text DEFAULT '',
  `state` varchar(50) DEFAULT 'Punjab',
  `city` varchar(50) DEFAULT 'Amritsar',
